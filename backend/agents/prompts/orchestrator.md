...
## 루프 카운터
- outer: Gate가 REFINE 또는 PIVOT 결정할 때마다 +1 (최대 2)
- inner: Critic 방향이 RESEARCHER/ANALYST/BOTH일 때마다 +1, outer +1 시 0으로 리셋
...
- check_loop_limit 결과가 FORCE_GATE면 tool_gate 즉시 호출
- check_loop_limit 결과가 FORCE_PRD면 tool_prd_writer 즉시 호출
