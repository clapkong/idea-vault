...
const EXAMPLE_PROMPTS = [
  '취업 포트폴리오 만들어야 해요. 백엔드 개발자 (주로 사용하는 언어: JavaSpring) 지망생이에요. 프로젝트에 취업할 때 제 역량이 최대한 부각될 수 있는 요소가 많이 있었으면 좋겠어요. 시간은 한 3주 정도 잡고 있어요',
  '소프트웨어 3학년 전공 캡스톤 수업 프로젝트인데 팀이 3명이고 한 학기 동안 해야 해요. 교수님께서 실생활과 연관된 주제를 원하세요. 팀원은 JavaScript 포함한 웹 프론트 1명, Swift 경력자 1명, 나머지 한명은 SQLD가 있고 백엔드를 공부하고 싶어해요. 디자인 하기 싫고 ML은 너무 어려워요. 투두앱 같은 뻔한 건 만들기 싫어요.',
  '저 개발 시작한 지 한 달 됐어요. 유튜브로 파이썬 기초만 봤고요. 뭔가 제가 쓸 수 있는걸 만들어보고 싶은데 뭘 만들 수 있는지도 모르겠어요. 저 음악 진짜 좋아하는데 음악이랑 개발 연결하고 싶어요. 근데 꼭 음악이 아니여도 괜찮아요. 돈 없어서 유료 API 못 써요. 2주 안에 끝내야 하고 혼자예요.',
]
